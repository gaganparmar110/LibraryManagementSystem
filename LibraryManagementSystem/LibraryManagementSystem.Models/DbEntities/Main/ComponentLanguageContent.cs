...
namespace LibraryManagementSystem.Models.Main
{
    ...
    public partial class ComponentLanguageContent
    {
        ...
        [InverseProperty(nameof(LibraryManagementSystem.Models.Main.LanguageContentKey.ComponentLanguageContents))]
        ...
        [InverseProperty(nameof(LibraryManagementSystem.Models.Main.LanguageContent.ComponentLanguageContents))]
